  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center bg-black">
      ...
      <div className="absolute right-8 bottom-24 flex flex-col items-center gap-6">
        ...
        >
          <Heart
            className={`w-8 h-8 ${video.is_liked ? "fill-primary text-primary" : ""}`}
          />
          <span className="text-xs font-semibold">{formatCount(video.like_count)}</span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-semibold">{formatCount(video.comment_count)}</span>
        </button>
        ...
        >
          ...
          <span className="text-xs font-semibold">{formatCount(video.glitch_count)}</span>
        </button>
